...
export default function InstructorVideoPage() {
  ...
  // This is always instructor mode since it's the instructor route
  const isInstructorMode = true
  ...
  }, [videoId, lesson?.id, lesson?.youtubeUrl])
