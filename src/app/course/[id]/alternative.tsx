              ...
              {[
                {
                  ...
                  description: "Get contextual hints when you pause, rewind, or seem confused",
                  example: "Stuck on CSS positioning? I'll explain the box model with visual examples."
                },
                {
                  icon: Brain,
                  name: "Puzzle Check", 
                  ...
                  example: "Quick check: What's the difference between margin and padding?"
                },
                {
                  icon: MessageSquare,
                  name: "Puzzle Reflect",
                  ...
                  description: "Guided reflection prompts to deepen understanding",
                  example: "How would you explain flexbox to a complete beginner?"
                },
                {
                  icon: Target,
                  name: "Puzzle Path",
                  ...
                  description: "Adaptive learning paths when struggling is detected",
                  example: "I noticed you're struggling with JS arrays. Here's some extra practice."
                }
              ].map((feature, index) => (
                <Card key={index} className={`${feature.bg} border-0`}>
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      <div className={`rounded-lg p-3 bg-white dark:bg-gray-900 ${feature.color}`}>
