...
interface InstructorResponse {
  ...
  message: string
  timestamp: string
  type: 'feedback' | 'encouragement' | 'assignment' | 'review'
}
    ...
    instructorResponses: [
      {
        ...
        message: 'Great insight! User research IS complex, but you\'re asking the right questions. Try the "5 Whys" technique in your next research session - it helps dig deeper into user motivations.',
    ...
    instructorResponses: [
      {
        id: 'inst_2',
        instructorName: 'John Smith',
        message: '🎉 Huge milestone! Your first client call is always nerve-wracking but you handled it well. For e-commerce work, I\'m assigning you a Shopify design exercise. This will strengthen your portfolio in that area.',
        timestamp: '2024-09-22 19:45:00',
        type: 'assignment'
      }
    ]
  },
    ...
    instructorResponses: [
      {
        id: 'inst_3',
        instructorName: 'John Smith',
        message: 'Excellent research work! 15 websites is thorough analysis. I can see you\'re developing a good eye for design patterns. Keep documenting what you learn - this research will be valuable for your portfolio case studies.',
        timestamp: '2024-09-19 21:15:00',
        type: 'encouragement'
      }
    ]
  },
...
export function MockGoalDashboard() {
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <div className="flex items-center gap-2 text-blue-900">
          ...
          <h1 className="text-lg font-semibold">Goals Mock Data Preview</h1>
        </div>
        <p className="text-sm text-blue-700 mt-1">
          This is what the student goals page looked like with rich mock data from previous commits.
        </p>
      </div>
            ...
            {mockDailyEntries.map((entry) => (
              <div key={entry.day} className="relative">
                ...
                <div className="ml-20 space-y-2">
                  ...
                  {entry.instructorResponses && entry.instructorResponses.length > 0 && (
                    <div className="mt-3">
                      <h5 className="text-xs font-medium text-green-700 dark:text-green-300 mb-2">
                        👨‍🏫 Instructor Response{entry.instructorResponses.length > 1 ? 's' : ''}
                      </h5>
                      <div className="space-y-2">
                        {entry.instructorResponses.map((response) => (
                          <div key={response.id} className="p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg">
                            ...
                            <p className="text-green-800 dark:text-green-100 text-sm leading-relaxed">
                              {response.message}
                            </p>
                          </div>
                        ))}
