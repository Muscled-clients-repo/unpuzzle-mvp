...
import { guestSimilarStudents, guestRecentlyCompletedStudents, guestRecentActivities } from './mock-data/guest-goals'
...
export default function CommunityGuestPage() {
  const guestGoalData = {
    similarStudents: guestSimilarStudents,
    recentlyCompletedStudents: guestRecentlyCompletedStudents,
