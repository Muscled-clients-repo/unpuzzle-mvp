...
import { useProjectTags, useUpdateProjectTags } from "@/hooks/use-studio-queries"

interface BulkProjectTagModalProps {
  isOpen: boolean
  onClose: () => void
...
export function BulkProjectTagModal({
  isOpen,
  onClose,
  selectedProjectIds,
  selectedProjectCount
}: BulkProjectTagModalProps) {
  ...
  const isLoading = updateTagsMutation.isPending
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Add tags to {selectedProjectCount} selected project{selectedProjectCount !== 1 ? 's' : ''}
          </DialogDescription>
        </DialogHeader>
