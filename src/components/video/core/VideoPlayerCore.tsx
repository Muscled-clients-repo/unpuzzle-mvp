...
export interface VideoPlayerCoreRef {
  pause: () => void
  play: () => void
  isPaused: () => boolean
...
interface VideoPlayerCoreProps {
  ...
  title?: string
  transcript?: string
  videoId?: string // Optional: for transcript panel
...
export const VideoPlayerCore = forwardRef<
  VideoPlayerCoreRef,
...
>(({
  ...
  // Generic video state (universal playback)
  ...
  useDocumentEventListener('keydown', handleKeyDown, undefined, 'VideoPlayerCore')
