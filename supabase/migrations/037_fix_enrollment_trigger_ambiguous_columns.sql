-- Fix ambiguous column references in enrollment progress trigger
-- This fixes the "column reference 'total_videos' is ambiguous" error
...
BEGIN
  ...
  -- Get course duration for time estimation
